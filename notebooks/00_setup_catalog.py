...
# MAGIC %md
# MAGIC # E-Commerce Retail Platform — Unity Catalog Setup
# MAGIC Creates the catalog schemas and grants for the E-Commerce Retail Platform.
# MAGIC
...
# will automatically use ecommerce_catalog.bronze, ecommerce_catalog.silver, etc.
